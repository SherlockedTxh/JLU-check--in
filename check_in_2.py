...
class clock_in:
    ...
    def login(self, dic):
        ...
        # 点击校外
        element = self.browser.find_element_by_xpath('//input[@id="V1_CTRL64"]')
        self.browser.execute_script("arguments[0].click();", element)

        # 输入位置
        Select(self.browser.find_element_by_xpath(
            "//select[@id='V1_CTRL47']")).select_by_value(
            dic['wz'])
        ...
        s1 = self.browser.find_element_by_xpath('/html[1]/body[1]/div[4]/form[1]/div[1]/div[3]/div[3]/div[1]/div[1]/div[2]/table[1]/tbody[1]/tr[2]/td[1]/div[1]/table[1]/tbody[1]/tr[11]/td[2]/div[1]/div[1]/div[1]/div[1]/input[1]')
        s1.clear()
        s1.send_keys(u'XX省')

        s1 = self.browser.find_element_by_xpath('/html[1]/body[1]/div[4]/form[1]/div[1]/div[3]/div[3]/div[1]/div[1]/div[2]/table[1]/tbody[1]/tr[2]/td[1]/div[1]/table[1]/tbody[1]/tr[11]/td[4]/div[1]/div[1]/div[1]/div[1]/input[1]')
        s1.clear()
        s1.send_keys(u'XX市')

        s1 = self.browser.find_element_by_xpath('/html[1]/body[1]/div[4]/form[1]/div[1]/div[3]/div[3]/div[1]/div[1]/div[2]/table[1]/tbody[1]/tr[2]/td[1]/div[1]/table[1]/tbody[1]/tr[11]/td[6]/div[1]/div[1]/div[1]/div[1]/input[1]')
        s1.clear()
        s1.send_keys(u'XX区')

        s1 = self.browser.find_element_by_xpath('/html[1]/body[1]/div[4]/form[1]/div[1]/div[3]/div[3]/div[1]/div[1]/div[2]/table[1]/tbody[1]/tr[2]/td[1]/div[1]/table[1]/tbody[1]/tr[11]/td[8]/div[1]/input[1]')
        s1.clear()
        s1.send_keys(u'XX地址')

        # 点击14天
        element = self.browser.find_element_by_xpath('//input[@id="V1_CTRL66"]')
        self.browser.execute_script("arguments[0].click();", element)

        #点击硕士
        #self.browser.find_element_by_xpath('//*[@id="V1_CTRL44"]').click()
        element = self.browser.find_element_by_xpath('//input[@id="V1_CTRL44"]')
        self.browser.execute_script("arguments[0].click();", element)
        print('填写基本信息...')
        self.log += '填写基本信息...\t'
